...
<tr><td>Oyentes Actuales:</td><td class="streamdata"> <xsl:value-of select="listeners*29" /></td></tr>
</xsl:if>
<xsl:if test="listener_peak">
<tr><td>Peak Listeners:</td><td class="streamdata"> <xsl:value-of select="listener_peak*29" /></td></tr>
</xsl:if>
<xsl:if test="genre">
